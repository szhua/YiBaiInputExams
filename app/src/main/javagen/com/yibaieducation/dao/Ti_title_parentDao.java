...
/** 
 * DAO for table TI_TITLE_PARENT.
*/
public class Ti_title_parentDao extends AbstractDao<Ti_title_parent, Long> {

    public static final String TABLENAME = "TI_TITLE_PARENT";

    /**
     * Properties of entity Ti_title_parent.<br/>
    ...
    */
    ...
    public Ti_title_parentDao(DaoConfig config) {
        super(config);
    }
    
    public Ti_title_parentDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'TI_TITLE_PARENT' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'TI_TITLE_PARENT'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, Ti_title_parent entity) {
        stmt.clearBindings();
    ...
    @Override
    protected void attachEntity(Ti_title_parent entity) {
    ...
    /** @inheritdoc */
    @Override
    public Ti_title_parent readEntity(Cursor cursor, int offset) {
        Ti_title_parent entity = new Ti_title_parent( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, Ti_title_parent entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(Ti_title_parent entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(Ti_title_parent entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
